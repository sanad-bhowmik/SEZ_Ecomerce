        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body item_edit_form">
                    ...
                    <h5>{{__('product.google_product_category_id')}}: <p class="d-inline" id="google_product_category_id"></p></h5>
                    @endif
                    @if(isModuleActive('MultiVendor'))
                    <h5>{{__('common.commission_rate')}}: <p class="d-inline" id="commission_rate"></p></h5>
                    @endif
