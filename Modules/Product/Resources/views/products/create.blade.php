        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
            ...
            <div class="tab-content">
                                    ...
                                    <div class="col-lg-6 sku_single_div">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="product_sku" id="sku_single"
                                                placeholder="{{ __('product.product_sku') }}" type="text" value="{{old('product_sku')}}">
                ...
                <div role="tabpanel" class="tab-pane fade" id="RelatedProduct">
                    ...
                    <input name="rtitle" class="primary_input_field" placeholder="Quick Search" type="text" id="rsearch_products">
                ...
                <div role="tabpanel" class="tab-pane fade" id="UpSale">
                    ...
                    <input name="utitle" class="primary_input_field" placeholder="Quick Search" type="text" id="upsale_search_products">
                    <div class="QA_section QA_section_heading_custom check_box_table">
                ...
                <div role="tabpanel" class="tab-pane fade" id="CrossSale">
                    ...
                    <input name="ctitle" class="primary_input_field" placeholder="Quick Search" type="text" id="crosssale_search_products">
                    <div class="QA_section QA_section_heading_custom check_box_table">
