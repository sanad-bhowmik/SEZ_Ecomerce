    ...
    public function up()
    {
        if(Schema::hasTable('backendmenus')){
            $sql = [
                ...
                ['is_admin' => 1,'is_seller' => 1, 'module' => 'MultiVendor', 'icon' => 'fas fa-user', 'parent_id' => 63, 'name' => 'review.my_review', 'route' => 'my-reviews.index', 'position' => 6],
        ...
        if(Schema::hasTable('permissions')){
            ...
            if($my_review){
                $my_review->update([
                    'route' => 'seller.seller.my-reviews.index'
                ]);
            }
