...
<form action="{{ route('company_information_update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('common.latitude')}}</label>
                <input class="primary_input_field" placeholder="-" type="text" id="latitude" name="latitude"
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('common.longitude')}}</label>
                <input class="primary_input_field" placeholder="-" type="text" id="longitude" name="longitude"
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('common.facebook')}}</label>
                <input class="primary_input_field" placeholder="-" type="text" id="facebook" name="facebook"
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('common.twitter')}}</label>
                <input class="primary_input_field" placeholder="-" type="text" id="twitter" name="twitter"
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('common.linkedin')}}</label>
                <input class="primary_input_field" placeholder="-" type="text" id="linkedin" name="linkedin"
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="primary_input_label" for="">{{__('common.instagram')}}</label>
                <input class="primary_input_field" placeholder="-" type="text" id="instagram" name="instagram"
