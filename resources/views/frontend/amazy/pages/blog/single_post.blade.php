                    ...
                    <div class="blog_details_inner m-0">
                        <div class="blog_details_banner">
                            @if(isset($post->image_url))
                                <img class="img-fluid w-100" src="{{showImage($post->image_url)}}" alt="">
                            @endif
                        </div>
                                ...
                                <div class="single_reviews flex-column">
                                    <div class="single_reviews">
                                        <div class="thumb">
                                            ...
                                            @else
                                                <img src="{{showImage(@$comment->commentUser->avatar)}}" alt="#" />
                                            @endif
                                        </div>
                                        <div class="review_content">
                                            ...
                                            <p>{{$comment->comment}}</p>
                                            @auth
                                                <button class="amaz_primary_btn style3 text-nowrap mt-2 mb-2 reply" cid="{{ $comment->id }}" post_id="{{ $post->id }}" token="{{ csrf_token() }}">{{__('blog.Replay')}}</button>
                                        ...
                                        @foreach ($comment->replay as $replay)
                                            <div class="single_reviews">
                                                <div class="thumb">
                                                    ...
                                                    @else
                                                        <img src="{{showImage(@$replay->replayUser->avatar)}}" alt="#" />
                                                    @endif
                                                </div>
                                                <div class="review_content">
                                                    <div class="review_content_head d-flex justify-content-between align-items-start flex-wrap">
                                                    ...
                                                    <div class="single_reviews">
                                                        <div class="single_reviews">
                                                            <div class="thumb">
                                                                ...
                                                                @else
                                                                    <img src="{{showImage(@$rreplay->replayUser->avatar)}}" alt="#" />
                                                                @endif
                                                            </div>
                                                            <div class="review_content">
                                                                <div class="review_content_head d-flex justify-content-between align-items-start flex-wrap">
