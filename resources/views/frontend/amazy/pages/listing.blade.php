    ...
    <div class="row">
        <div class="col-12">
            <div class="section__title d-flex align-items-center gap-3 mb_30 flex-wrap">
                <h3 id="best_deals_title" class="m-0 flex-fill">Shops</h3>
    ...
    <div class="container">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4">
            <div class="amaz_home_cartBox amaz_cat_bg1 d-flex justify-content-between mb_30">
                <div class="img_box">
                    <img class="lazyload" src="{{showImage(themeDefaultImg())}}" data-src="{{showImage(@$seller->photo ?@$seller->photo:'frontend/default/img/default_category.png')}}" alt="">
                </div>
                <div class="amazcat_text_box">
                    <h4>
                        <a href="{{route('frontend.seller',$seller->slug)}}">{{ $seller->seller_shop_display_name ? $seller->seller_shop_display_name : $seller->slug }}</a>
                    </h4>
