                                    ...
                                    @if(count($product->product->gallary_images) > 0)
                                        @foreach($product->product->gallary_images as $image)
                                            <div class="item-slick {{$product->product->gallary_images->first()->id == $image->id?'slick-current slick-active':''}}" id="thumb_{{$image->id}}">
                                                <img class="varintImg zoom_01" src="{{showImage($image->images_source)}}" data-zoom-image="{{showImage($image->images_source)}}" alt="">
                                            </div>
                                        @endforeach
                                    @else
                                        <div class="item-slick slick-current slick-active" id="thumb_{{$product->id}}">
                                            <img class="varintImg zoom_01" @if ($product->thum_img != null) data-zoom-image="{{showImage($product->thum_img)}}" @else data-zoom-image="{{showImage($product->product->thumbnail_image_source)}}" @endif @if ($product->thum_img != null) src="{{showImage($product->thum_img)}}" @else src="{{showImage($product->product->thumbnail_image_source)}}" @endif alt="">
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="product_content_details mb_20">
                                ...
                                <div class="product_ratings">
                                    ...
                                    <span>{{sprintf("%.2f",$rating)}}/5 ({{($total_review<10 && $total_review>0)?'0':''}}{{$total_review}} {{__('defaultTheme.review')}})</span>
                                </div>
                                ...
                                <div class="product_info">
                                    ...
                                    <div class="single_pro_varient">
                                        ...
                                        <div class="product_number_count mr_5" data-target="amount-1">
                                            ...
                                            <input name="qty" id="qty" class="count_single_item input-number qty" type="text" readonly value="{{@$product->product->minimum_order_qty}}">
                            ...
                            <div class="product_details_dec mb_76">
                                ...
                                <div class="product_details_dec_body">
                                    <div class="single_desc style2 mb_20">
                                        ...
                                        <p class="f_w_500 m-0">{{ __('common.minimum_order_quantity') }}: {{@$product->product->minimum_order_qty}}</p>
                                        <p class="f_w_500 m-0">{{ __('common.maximum_order_quantity') }}: {{@$product->product->max_order_qty}}</p>
                                            ...
                                            <div class="product_widget5 mb_30">
                                                <div class="product_thumb_upper">
                                                    ...
                                                    <a href="{{singleProductURL($recent_viewed_product->seller->slug, $recent_viewed_product->slug)}}" class="thumb">
                                                        <img data-src="{{$thumbnail}}" src="{{showImage(themeDefaultImg())}}" alt="{{@$recent_viewed_product->product_name}}" class="lazyload">
                                                    </a>
                                                                ...
                                                                <span class="badge_1">
                                                                    @if($recent_viewed_product->hasDeal->discount >0)
                                                                        @if($recent_viewed_product->hasDeal->discount_type ==0)
                                                                            {{$recent_viewed_product->hasDeal->discount}} % off
                                                                        @else
                                                                            {{single_price($recent_viewed_product->hasDeal->discount)}} off
                                                                        @endif
                                                                ...
                                                                <span class="badge_1">
                                                                    @if($recent_viewed_product->discount >0)
                                                                        @if($recent_viewed_product->discount_type ==0)
                                                                            {{$recent_viewed_product->discount}} % off
                                                                        @else
                                                                            {{single_price($recent_viewed_product->discount)}} off
                                                                        @endif
                                                                    @endif
                                                                </span>
                                                            @endif
                    ...
                    @if($free_shipping)
                        <div class="amazcart_delivery_wiz mb_20">
                            ...
                            <div class="amazcart_delivery_wiz_body">
                                ...
                                <p class="delivery_text font_14 f_w_400">Free Shipping on {{$free_shipping->method_name}} starts from order amount {{single_price($free_shipping->minimum_shopping)}}</p>
                            </div>
                        </div>
                    @endif
                    <div class="amazcart_delivery_wiz mb_20">
                        ...
                        <div class="amazcart_delivery_wiz_body">
                            ...
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 mb_10">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{url('/')}}/public/frontend/amazy/img/product_details/details_car.svg" alt="">
                                </div>
                            ...
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 ">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{url('/')}}/public/frontend/amazy/img/product_details/details_pickup.svg" alt="">
                                </div>
                                <div class="amazcart_delivery_wiz_content">
                                ...
                                <div class="seller_performance_box">
                                    ...
                                    @foreach($product->seller->sellerReviews->where('status',1) as $seller_review)
                                        <div class="single_seller_performance d-flex align-items-center gap_10 mb-1">
                                            <img src="{{showImage('frontend/amazy/img/product_details/star.svg')}}" alt="">
                                                    ...
                                                    <span class="badge_1">
                                                        @if($related_seller_product->hasDeal->discount >0)
                                                            @if($related_seller_product->hasDeal->discount_type ==0)
                                                                {{$related_seller_product->hasDeal->discount}} % off
                                                            @else
                                                                {{single_price($related_seller_product->hasDeal->discount)}} off
                                                            @endif
                                                    ...
                                                    <span class="badge_1">
                                                        @if($related_seller_product->discount >0)
                                                            @if($related_seller_product->discount_type ==0)
                                                                {{$related_seller_product->discount}} % off
                                                            @else
                                                                {{single_price($related_seller_product->discount)}} off
                                                            @endif
                                                        @endif
                                                    </span>
                                                @endif
