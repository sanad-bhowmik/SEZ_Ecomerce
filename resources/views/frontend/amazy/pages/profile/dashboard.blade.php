        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="row">
                        <div class="col-12">
                            <div class="dashBoard_cart_boxs mb_25">
                                <!-- single_items -->
                                <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                    ...
                                    <h3 class=" font_20 f_w_700 m-0">{{ $total_order_count }}</h3>
                                </div>
                                <!-- single_items -->
                                <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                    <div class="icon d-flex align-items-center justify-content-center text-center">
                                    ...
                                    <h3 class=" font_20 f_w_700 m-0">{{ $total_wishlist_count }}</h3>
                                </div>
                                <!-- single_items -->
                                <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                    <div class="icon d-flex align-items-center justify-content-center text-center">
                                    ...
                                    <h3 class=" font_20 f_w_700 m-0">{{ $total_success_refund }}</h3>
                                </div>
                                <!-- single_items -->
                                <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                    <div class="icon d-flex align-items-center justify-content-center text-center">
                                    ...
                                    <h3 class=" font_20 f_w_700 m-0">{{ $total_item_in_carts }}</h3>
                                </div>
                                <!-- single_items -->
                                <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                    <div class="icon d-flex align-items-center justify-content-center text-center">
                                    ...
                                    <h3 class=" font_20 f_w_700 m-0">{{ $total_coupon_used }}</h3>
                                </div>
                                <!-- single_items -->
                                <div class="single_cart_box d-flex align-items-center justify-content-center text-center flex-column">
                                    <div class="icon d-flex align-items-center justify-content-center text-center">
                                    ...
                                    <h3 class=" font_20 f_w_700 m-0">{{ $total_completed_order_count }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <div class="dashboard_white_box bg-white mb_25 amazy_full_height">
                                <div class="dashboard_white_box_header d-flex align-items-center gap_15 pb_10 mb_5">
                                    <h3 class="font_20 f_w_700 mb-0  flex-fill">Purchase History</h3>
                                    <a href="{{route('frontend.my_purchase_histories')}}" class="amaz_badge_btn3 text-uppercase text-nowrap">See all</a>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table amazy_table mb-0">
                                            <thead>
                                                ...
                                                <th class="font_14 f_w_700 border-start-0 border-end-0" scope="col">Amout</th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            <h4 class="font_16 f_w_700  ">Order: {{@$order->order->order_number}}</h4>
                                                            @if(isModuleActive('MultiVendor'))
                                                                <h4 class="font_14 f_w_600  ">Package: {{@$order->package_code}}</h4>
                                                            @endif
                                                    ...
                                                    <td>
                                                        @if($order->is_cancelled)
                                                            <a class="table_badge_btn style_5 text-nowrap">Cancelled</a>
                                                        @elseif($order->delivery_status == 1)
                                                            <a class="table_badge_btn style3 text-nowrap">Pending</a>
                                                        @elseif($order->delivery_status == 2)
                                                            <a class="table_badge_btn text-nowrap">Processing</a>
                                                        @elseif($order->delivery_status == 3)
                                                            <a class="table_badge_btn text-nowrap">Shipped</a>
                                                        @elseif($order->delivery_status == 4)
                                                            <a class="table_badge_btn text-nowrap">Received</a>
                                        ...
                                        @foreach ($wishlists as $key => $product)
                                            @if($product->type == 'product')
                                                <a href="{{singleProductURL(@$product->product->seller->slug, @$product->product->slug)}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                                    <div class="thumb">
                                                        <img class="img-fluid" src="@if(@$product->product->thum_img != null) {{showImage(@$product->product->thum_img)}} @else {{showImage(@$product->product->product->thumbnail_image_source)}} @endif" alt="">
                                                    </div>
                                            ...
                                            @else
                                                <a href="{{route('frontend.gift-card.show',@$product->giftcard->sku)}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                                    <div class="thumb">
                                                        <img class="img-fluid" src="{{showImage(@$product->giftcard->thumbnail_image)}}" alt="">
                                                    </div>
                                                    <div class="dashboard_order_content">
                        ...
                        <div class="col-lg-6 ">
                            <div class="dashboard_white_box bg-white mb_25 amazy_full_height">
                                <div class="dashboard_white_box_header d-flex align-items-center gap_15 amazy_bb3 pb_10 mb_5">
                                    <h3 class="font_20 f_w_700 mb-0  flex-fill">Recent Order</h3>
                                    <a href="{{url('/my-purchase-orders')}}" class="amaz_badge_btn2 text-uppercase">See all</a>
                                </div>
                                <div class="dashboard_white_box_body">
                                    <div class="dash_product_lists">
                        ...
                        <div class="col-lg-6 ">
                            <div class="dashboard_white_box bg-white mb_25 amazy_full_height">
                                <div class="dashboard_white_box_header d-flex align-items-center gap_15 amazy_bb3 pb_10 mb_5">
                                    <h3 class="font_20 f_w_700 mb-0  flex-fill">Product in Cart</h3>
                                    <a href="{{url('/cart')}}" class="amaz_badge_btn2 text-uppercase">See all</a>
                                </div>
                                <div class="dashboard_white_box_body">
                                    <div class="dash_product_lists">
                                        @foreach($carts as $key => $cart)
                                            ...
                                            @else
                                                <a href="{{route('frontend.gift-card.show',$cart->giftCard->sku)}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                                    <div class="thumb">
                                                        <img class="img-fluid" src="{{showImage(@$cart->giftCard->thumbnail_image)}}" alt="">
                                                    </div>
                                                    <div class="dashboard_order_content">
