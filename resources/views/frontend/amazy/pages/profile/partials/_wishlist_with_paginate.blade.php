...
<div class="dashboard_white_box style2 bg-white mb_25">
    <div class="d-flex align-items-center gap_20 mb_30">
        <h5 class="font_14 f_w_400 flex-fill">Showing @if($show_start == $show_end) {{$show_end}} @else {{$show_start}} - {{$show_end}} @endif of {{$total_number_of_items}} Results</h5>
        <div class="wish_selects d-flex align-items-center gap_10 flex-wrap">
            <select class="amaz_select4" name="paginate_by" id="paginate_by">
                <option value="8" @if (isset($paginate) && $paginate == "8") selected @endif>Show 8 item’s</option>
                <option value="12" @if (isset($paginate) && $paginate == "9") selected @endif>Show 12 item’s</option>
                <option value="16" @if (isset($paginate) && $paginate == "12") selected @endif>Show 16 item’s</option>
                <option value="24" @if (isset($paginate) && $paginate == "15") selected @endif>Show 16 item’s</option>
                <option value="32" @if (isset($paginate) && $paginate == "32") selected @endif>Show 32 item’s</option>
            </select>
                    ...
                    <div class="product_widget5 style3 bg-white">
                        <div class="product_thumb_upper">
                            <a href="{{singleProductURL(@$product->product->seller->slug, @$product->product->slug)}}" class="thumb">
                                <img src="{{$thumbnail}}" alt="{{@$product->product->product_name}}">
                            </a>
