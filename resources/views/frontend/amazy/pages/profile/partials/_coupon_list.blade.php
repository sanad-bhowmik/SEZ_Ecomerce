<div class="table_border_whiteBox mb_30">
    <div class="table-responsive">
        <table class="table amazy_table style4 mb-0">
            <thead>
                <tr>
                    <th class="font_14 f_w_700 priamry_text text-nowrap" scope="col">Coupon Value</th>
                    <th class="font_14 f_w_700 priamry_text border-start-0 border-end-0 text-nowrap" scope="col">Store Name</th>
                    <th class="font_14 f_w_700 priamry_text border-start-0 border-end-0 text-nowrap" scope="col">Coupon Code</th>
                    <th class="font_14 f_w_700 priamry_text border-start-0 border-end-0 text-nowrap" scope="col">Validity</th>
                    <th class="font_14 f_w_700 priamry_text border-start-0 border-end-0 text-nowrap" scope="col">Action</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($coupons as $key => $coupon)
                    <tr>
                        ...
                        <td>
                            <span class="font_14 f_w_500 mute_text text-nowrap">Start
                                {{ date('dS M, Y', strtotime(@$coupon->coupon->start_date)) }} <br> End
