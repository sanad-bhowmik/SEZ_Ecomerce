                    ...
                    <div class="dashboard_white_box_body">
                        <div class="table-responsive">
                            <table class="table amazy_table style2 mb-0">
                                <thead>
                                    <tr>
                                    <th class="font_14 f_w_700 text-no" scope="col">Amount</th>
                                    <th class="font_14 f_w_700 border-start-0 border-end-0 text-no" scope="col">Name</th>
                                    <th class="font_14 f_w_700 border-start-0 border-end-0 text-no" scope="col">QTY</th>
                                    <th class="font_14 f_w_700 border-start-0 border-end-0 text-nowrap" scope="col">Secret Code</th>
                                    <th class="font_14 f_w_700 text-no" scope="col">Is Used</th>
                                    </tr>
                                </thead>
                                <tbody>
