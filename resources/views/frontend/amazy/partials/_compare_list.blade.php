                            ...
                            <div class="product_widget5 border-0">
                                        ...
                                        @if($sellerProductSKU->product->hasDeal->discount > 0)
                                            <span class="badge_1 text-nowrap">
                                                @if($sellerProductSKU->product->hasDeal->discount_type == 0)
                                                    {{$sellerProductSKU->product->hasDeal->discount}} % {{__('common.off')}}
                                                @else
                                        ...
                                        @if(@$sellerProductSKU->product->hasDiscount == 'yes')
                                            <span class="badge_1 text-nowrap">
                                                @if($sellerProductSKU->product->product->discount_type == 0)
                                                    {{$sellerProductSKU->product->product->discount}} % {{__('common.off')}}
                                                @else
                                ...
                                <div class="product__meta text-center">
                                    ...
                                    <div class="product_prise">
                                        ...
                                        @endphp
                                        <a href="" class="add_cart add_to_cart addToCart" data-product_sku_id="{{$sellerProductSKU->id}}" data-seller_id="{{@$sellerProductSKU->product->user_id}}" data-shipping_method="{{$shipping_method}}" data-price="{{$price}}" data-prod_info="{{ json_encode($showData) }}">Add To Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
