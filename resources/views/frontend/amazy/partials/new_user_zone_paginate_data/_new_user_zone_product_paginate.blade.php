        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="product_widget5 mb_25">
                ...
                <div class="product_thumb_upper">
                    ...
                    @endphp
                    <a href="{{singleProductURL(@$product->product->seller->slug, @$product->product->slug)}}" class="product_img_iner thumb">
                        <img data-src="{{$thumbnail}}" src="{{showImage(themeDefaultImg())}}" alt="{{@$product->product->product_name}}" class="img-fluid lazyload">
                    </a>
