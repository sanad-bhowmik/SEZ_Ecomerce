<div class="row ">
    ...
    <div class="col-12">
        <div class="box_header d-flex flex-wrap align-items-center justify-content-between">
            <h5 class="font_16 f_w_500 mr_10 mb-0">Showing @if($show_start == $show_end) {{$show_end}} @else {{$show_start}} - {{$show_end}} @endif of {{$total_number_of_items}} Results</h5>
                        ...
                        <div class="product_widget5 mb_30 style5">
                            <div class="product_thumb_upper">
                                ...
                                <a href="{{route('frontend.gift-card.show',$card->sku)}}" class="thumb">
                                    <img src="{{$thumbnail}}" alt="{{@$card->name}}">
                                </a>
