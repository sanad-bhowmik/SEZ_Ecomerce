        ...
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '#add_to_cart_btn_modal', function(event){
                    ...
                    addToCart($('#product_sku_id_modal').val(),$('#seller_id_modal').val(),$('#qty_modal').val(),$('#base_sku_price_modal').val(),$('#shipping_type').val(),'product', showData);
                });

                $(document).on("click", ".buy_now_btn", function(event){
                    event.preventDefault();
                    buyNow($('#product_sku_id_modal').val(),$('#seller_id_modal').val(),$('#qty_modal').val(),$('#base_sku_price_modal').val(),$('#shipping_type').val(),'product');
                });
