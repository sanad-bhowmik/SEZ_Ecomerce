                ...
                <div class="add_cart_modalAdded">
                    ...
                    <div class="cart_added_box">
                        <a href="" id="cart_suceess_url" class="cart_added_box_item d-flex align-items-center gap_25 flex-sm-wrap flex-md-nowrap">
                            <div class="thumb">
                                <img class="img-fluid" id="cart_suceess_thumbnail" src="{{url('/')}}/public/frontend/amazy/img/cart_added_thumb.png" alt="">
                            </div>
                    ...
                    <div class="d-flex flex-column gap_10">
                        <a href="{{url('/cart')}}" class="amaz_primary_btn style2 text-uppercase ">View cart</a>
                        <a href="{{url('/checkout')}}" class="amaz_primary_btn style2 text-uppercase ">Process to Checkout</a>
                    </div>
                </div>
            </div>
        </div>
