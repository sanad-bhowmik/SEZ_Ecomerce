...
Route::get('/',[WelcomeController::class,'landing'])->name('frontend.index');
Route::get('/home',[WelcomeController::class,'index'])->name('frontend.welcome');
...
//staff
 ...
 Route::get('/push-notification',[NotificationController::class,'pushNotification'])->name('admin.push.notification');
 Route::post('/push-notification-store',[NotificationController::class,'pushNotificationStore'])->name('push.notification.store');
